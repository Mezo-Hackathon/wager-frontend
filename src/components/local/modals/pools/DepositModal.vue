 ...
 * Services
 */
import { flameWager as juster, analytics, approveMUSD } from "@sdk"
...
const handleDeposit = async () => {
	...
	try {
        ...
        // Step 1: Approve MUSD
        await approveMUSD(props.selectedPool.address, amountWei)
...
const buttonState = computed(() => {
	...
	if (amount.value > 0 && amount.value < 0.01) return { text: "Minimum 0.01 MUSD", disabled: true, type: "secondary" }
				...
				<Flex align="center" justify="between" :class="$style.badge">
					<Flex align="center" gap="8">
						...
						<Flex align="center">
							...
							>&nbsp; <Text size="14" weight="600" color="tertiary"> MUSD </Text>&nbsp;
