	...
	<div @click="showOperationModal = true" :class="$style.wrapper">
		...
		<div :class="$style.desktop">
			<div :class="[$style.param, $style.up]">
				{{ numberWithSymbol(formattedAmountAboveEq, ",") }}&nbsp;<span>MUSD</span>
			</div>

			<div v-if="event.status == 'FINISHED' && returnForLiquidity" :class="[$style.param]">
				{{ numberWithSymbol(returnForLiquidity, ",") }}&nbsp;<span>MUSD</span>
			</div>
		...
		<div :class="$style.mobile">
			...
			<div v-if="event.status == 'FINISHED' && returnForLiquidity" :class="[$style.param]">
				...
				<div :class="$style.value">{{ numberWithSymbol(returnForLiquidity, ",") }}&nbsp;<span>MUSD</span></div>
			</div>
