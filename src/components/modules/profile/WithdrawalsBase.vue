			...
			<div :class="$style.stats">
				<div :class="$style.stat">
					...
					<div :class="$style.stat_value">
						{{ statistics.week.value.toFixed(0) }} MUSD
					</div>
					<div :class="$style.stat_avg">
						Avg
						<span>{{ statistics.week.avg.toFixed(0) }} MUSD</span>
						per event
					</div>
				</div>
				<div :class="$style.stat">
					...
					<div :class="$style.stat_value">
						{{ statistics.month.value.toFixed(0) }} MUSD
					</div>
					<div :class="$style.stat_avg">
						Avg
						<span>{{ statistics.month.avg.toFixed(0) }} MUSD</span>
						per event
					</div>
				</div>
				<div :class="$style.stat">
					...
					<div :class="$style.stat_value">
						{{ statistics.all.value.toFixed(0) }} MUSD
					</div>
					<div :class="$style.stat_avg">
						Avg
						<span>{{ statistics.all.avg.toFixed(0) }} MUSD</span> per
						event
					</div>
				</div>
			</div>
